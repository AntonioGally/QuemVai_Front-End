    ...
    <div>
      ...
      <MyContainer>
        <Container fluid>
          ...
          <Social>
            <Row >
              <img src={facebook} alt="facebook logo" style={{width:"32px", height:"32px", marginBottom:"3%", cursor:"pointer"}}/>
              <div style={{marginLeft:"2%", cursor:"pointer"}}>ChumeCompany</div>
            </Row>
            <Row>
              <img src={instagram} alt="facebook logo" style={{width:"32px", height:"32px", cursor:"pointer"}}/>
              <div style={{marginLeft:"2%", cursor:"pointer"}}>ChumeCompany</div>
            </Row>
          </Social>
        </Container>
